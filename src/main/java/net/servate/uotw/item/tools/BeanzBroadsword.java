/*package net.servate.uotw.item.tools;
...
public class BeanzBroadsword extends BeanzSword {
    private final ToolMaterial material;
    private final float attackDamage;
    public final Multimap<EntityAttribute, EntityAttributeModifier> attributeModifiers;

    public BeanzBroadsword(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings) {
